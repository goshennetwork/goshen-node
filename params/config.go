...
type ChainConfig struct {
	...
	Layer2Instant *Layer2InstantConfig `json:"layer2Instant,omitempty"`
}

type Layer2InstantConfig struct {
	L2CrossLayerWitness common.Address `json:"l2CrossLayerWitness"`
	FeeCollector        common.Address `json:"feeCollector"`
}

func (self *Layer2InstantConfig) String() string {
...
func (c *ChainConfig) String() string {
	...
	case c.Clique != nil:
		engine = c.Clique
	case c.Layer2Instant != nil:
		engine = c.Layer2Instant
	default:
		engine = "unknown"
	}
