...
./geth --l2 --datadir chaindata/ --networkid 21772 --mine --miner.etherbase "0xf39fd6e51aad88f6f4ce6ab8827279cfffb92266" --verbosity=3 --gcmode archive --http --http.addr 0.0.0.0 --http.api "eth,net,web3,txpool" --http.port 23333 --ws --ws.addr 0.0.0.0 --syncmode full --snapshot=false --nat extip:xxx:xxx:xxx:xxx console
